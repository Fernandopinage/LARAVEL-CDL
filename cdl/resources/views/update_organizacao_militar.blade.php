        ...
        <div class="pessoais">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="tel" class="form-control form-control-sm" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" name="telefone" placeholder="(99) 99999-9999" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" value="{{$oms->oms_telefone}}" required>
                </div>
                <div class="col-md-3">
                    <label class="form-check-label" for="flexCheckIndeterminate">Telefone  <span><strong>*</strong></span></label>
                    <input type="tel" class="form-control form-control-sm" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" name="telefone2" placeholder="(99) 99999-9999" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" value="{{$oms->oms_celular}}" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" maxlength="8" class="form-control form-control-sm" name="cep" id="cep" placeholder="" value="{{$oms->oms_cep}}" required>
                </div>
                <div class="col-md-1">
