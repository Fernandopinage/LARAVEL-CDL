        ...
        <div class="row g-3">
            ...
            <div class="col-md-3" id="periodo_div">
                ...
                <select class="form-select form-select-sm" name="periodo" aria-label="Default select example"
                    ...
                    <option></option>
                    <option {{$candidato->can_periodo == '1º Período' ? 'selected' :''}} value="1º Período">1º Período
                    </option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="2º Período">2º Período
                    </option>
                    <option {{$candidato->can_periodo == '3º Período' ? 'selected' :''}} value="3º Período">3º Período
                    </option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="4º Período">4º Período
                    </option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="5º Período">5º Período
                    </option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="6º Período">6º Período
                    </option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="7º Período">7º Período
                    </option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="8º Período">8º Período
                    </option>
    ...
    @for($i = 0; $i <$tamanho2; $i++) <div class="row g-3 shadow p-4 mb-5 bg-body rounded"
                    ...
                    <div class="col-md-2" id="div_encrita">
                        ...
                        <div class="form-check ">
                            <input class="form-check-input" type="radio" name="idioma_escrita[]"
                                id="idioma_escrita_basico" value="option2" {{$candidato->can_idioma_escrita[$i] ==
                            'option2' ? 'checked' :''}}>
                        ...
                        <div class="form-check ">
                            <input class="form-check-input" type="radio" name="idioma_escrita[]"
                                id="idioma_escrita_internediario" value="option3" {{$candidato->can_idioma_escrita[$i]
                            == 'option3' ? 'checked' :''}}>
                        ...
                        <div class="form-check ">
                            <input class="form-check-input" type="radio" name="idioma_escrita[]"
                                id="idioma_escrita_avancado" value="option4" {{$candidato->can_idioma_escrita[$i] ==
                            'option4' ? 'checked' :''}}>
                    ...
                    <div class="col-md-2" id="div_leitura">
                        ...
                        <div class="form-check ">
                            <input class="form-check-input" type="radio" name="idioma_leitura[]"
                                id="idioma_leitura_basico" value="option2">
        ...
        <div class="form-signin">
            ...
            <div class="texto">
                ...
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>a</b></span>.
                    Quando
                ...
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>b</b></span>.
                    De posse
                ...
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>c</b></span>. A
                    CDL
                ...
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>d</b></span>. É
                    vedado
                    o acesso total de empresas não cadastradas aos seus dados.</p>
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>e</b></span>.
                    Se faz
                ...
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>f</b></span>.
                    Todas as
                ...
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>g</b></span>. O
                    uso do
                ...
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>a</b></span>. A
                ...
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>a</b></span>. O
                    CDL
                ...
                <p style="margin-left: 45px"><span
                        style="margin-right: 20px; color:#000;font-size:20px;"><b>b</b></span>. A
                    CDL
