...
<form action="/insert/candidato" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control form-control-sm" name="sobrenome"
                        value="{{$candidato->can_can_sobrenome}}" placeholder="">
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <select id="inputState" name="cor" class="form-select form-select-sm"
                        ...
                        <option {{$candidato->can_cor == 'Indígena' ? 'selected' :''}} value="Indígena" >Indígena</option>
                    </select>
                </div>
                <div class="col-md-1">
                ...
                <div class="col-md-2">
                    ...
                    <select id="inputState" name="estadocivil" class="form-select form-select-sm"
                        ...
                        <option></option>
                        <option {{$candidato->can_estadocivil == 'Solteiro' ? 'selected' :''}} value="Solteiro" >Solteiro</option>
                        <option {{$candidato->can_estadocivil == 'Casado' ? 'selected' :''}} value="Casado" >Casado</option>
                        <option {{$candidato->can_estadocivil == 'Viúvo' ? 'selected' :''}} value="Viúvo" >Viúvo</option>
                        <option {{$candidato->can_estadocivil == 'Separado' ? 'selected' :''}} value="Separado" >Separado</option>
                    </select>
                </div>
                <div class="col-md-2">
                    <label class="form-check-label" for="flexCheckIndeterminate">Possui filhos</label>
                    <div class="form-check ">
                        <input class="form-check-input" type="radio" name="filiacao" id="gridRadios1" value="option2" {{$candidato->can_filiacao == 'sim' ? 'checked' :''}}>
                        <label class="form-check-label" for="gridRadios1">
                            Sim
                        </label>
                    </div>
                    <div class="form-check ">
                        <input class="form-check-input" type="radio" name="filiacao" id="gridRadios2" value="option3" {{$candidato->can_filiacao == 'não' ? 'checked' :''}}>
                ...
                <div class="col-md-2">
                    ...
                    <select id="inputState" name="genero" class="form-select form-select-sm">
                        <option ></option>
                        <option {{$candidato->can_genero == 'Masculino' ? 'selected' :''}} value="Masculino">Masculino</option>
                        <option {{$candidato->can_genero == 'Feminino' ? 'selected' :''}} value="Feminino">Feminino</option>
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" class="form-control form-control-sm" name="pretensao_salario" placeholder="" value="{{$candidato->can_pretensao_salario}}" onKeyPress="return(moeda(this,'.',',',event))">
                </div>

                <div class="col-md-2" style="margin-top: 30px;">

                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="exmilitar" id="exmilitar"  {{$candidato->can_exmilitar == 'on' ? 'checked' :''}}>
                ...
                <div class="col-md-3" id="divMilitar">
                    ...
                    <input type="text" class="form-control form-control-sm" name="unidademilitar" placeholder="" value="{{$candidato->can_unidademilitar}}">
                </div>
                <div class="col-md-3">
                    <label class="form-check-label" for="flexCheckIndeterminate">Matrícula</label>
                    <input type="text" class="form-control form-control-sm" name="matricula" placeholder="" value="{{$candidato->can_matricula}}">
                </div>
    ...
    <div class="form-signin">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-sm" placeholder="" name="email" value="{{$candidato->can_email}}">
            </div>
            <div class="col-md-2">
                ...
                <input type="text" class="form-control form-control-sm" placeholder="(xx) xxxxx-xxxx"
                    ...
                    name="telefone" value="{{$candidato->can_telefone}}">
            </div>
            <div class="col-md-2">
                <label class="form-check-label" for="flexCheckIndeterminate">Celular </label>
                <input type="text" class="form-control form-control-sm" placeholder="(xx) xxxxx-xxxx"
                    onkeypress="mask(this, mphone);" onblur="mask(this, mphone);"
                    name="celular" value="{{$candidato->can_celular}}">
            </div>
    ...
    <div class="form-signin">
        ...
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <select class="form-select form-select-sm" name="formacao" id="formacao"
                    ...
                    <option {{$candidato->can_formacao == 'Ensino Fundamental completo' ? 'selected' :''}} value="Ensino Fundamental completo">Ensino Fundamental completo</option>
                    <option {{$candidato->can_formacao == 'Ensino Fundamental incompleto' ? 'selected' :''}} value="Ensino Fundamental incompleto">Ensino Fundamental incompleto</option>
                    <option {{$candidato->can_formacao == 'Ensino Médio completo' ? 'selected' :''}} value="Ensino Médio completo">Ensino Médio completo</option>
                    <option {{$candidato->can_formacao == 'Ensino Médio cursando' ? 'selected' :''}} value="Ensino Médio cursando">Ensino Médio cursando</option>
                    <option {{$candidato->can_formacao == 'Ensino Técnico cursando' ? 'selected' :''}} value="Ensino Técnico cursando">Ensino Técnico cursando</option>
                    <option {{$candidato->can_formacao == 'Ensino Técnico completo' ? 'selected' :''}} value="Ensino Técnico completo">Ensino Técnico completo</option>
                    <option {{$candidato->can_formacao == 'Superior Cursando' ? 'selected' :''}} value="Superior Cursando">Superior Cursando</option>
                    <option {{$candidato->can_formacao == 'Superior Completo' ? 'selected' :''}} value="Superior Completo">Superior Completo</option>
                    <option {{$candidato->can_formacao == 'Superior Completo' ? 'selected' :''}} value="Pós-Graduação Cursando">Pós-Graduação Cursando</option>
                    <option {{$candidato->can_formacao == 'Pós-Graduação Completo' ? 'selected' :''}} value="Pós-Graduação Completo">Pós-Graduação Completo</option>
                </select>
            </div>
            <div class="col-md-3" id="institucao_div">
                <label class="form-check-label" for="flexCheckIndeterminate">Instituição de Ensino </label>
                <input type="text" class="form-control form-control-sm" name="instituicao" placeholder="" value="{{$candidato->can_instituicao}}">
            </div>
            <div class="col-md-3" id="curso_div">
                <label class="form-check-label" for="flexCheckIndeterminate">Nome do curso </label>
                <input type="text" class="form-control form-control-sm" name="curso" placeholder="" value="{{$candidato->can_curso}}">
            </div>
            <div class="col-md-2" id="termino_div">
                <label class="form-check-label" for="flexCheckIndeterminate">Ano em Curso</label>
                <input type="month" class="form-control form-select-sm" name="termino" placeholder=""  value="{{$candidato->can_termino}}">
            </div>
            <div class="col-md-2" id="semestre_div">
                <label class="form-check-label" for="flexCheckIndeterminate">Semestre em Curso </label>
                <select class="form-select form-select-sm" name="semestre" aria-label="Default select example" value="{{$candidato->can_semestre}}">
                    <option selected></option>
                    <option {{$candidato->can_semestre == '1º Semestre' ? 'selected' :''}} value="1º Semestre">1º Semestre</option>
                    <option {{$candidato->can_semestre == '2º Semestre' ? 'selected' :''}} value="2º Semestre">2º Semestre</option>

                </select>
            </div>
            <div class="col-md-3" id="periodo_div">
                <label class="form-check-label" for="flexCheckIndeterminate">Período em Curso</label>
                <select class="form-select form-select-sm" name="periodo" aria-label="Default select example" value="{{$candidato->can_periodo}}">
                    <option></option>
                    <option {{$candidato->can_periodo == '1º Período' ? 'selected' :''}} value="1º Período">1º Período</option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="2º Período">2º Período</option>
                    <option {{$candidato->can_periodo == '3º Período' ? 'selected' :''}} value="3º Período">3º Período</option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="4º Período">4º Período</option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="5º Período">5º Período</option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="6º Período">6º Período</option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="7º Período">7º Período</option>
                    <option {{$candidato->can_periodo == '2º Período' ? 'selected' :''}} value="8º Período">8º Período</option>
                    <option {{$candidato->can_periodo == 'Ou Mais' ? 'selected' :''}} value="Ou Mais">Ou Mais</option>
        ...
        @php
            $tamanho = count($candidato->can_curso_ano_termino);
        ...
        <div class="row g-3 shadow p-4 mb-5 bg-body rounded" style="margin:0px 20px 0px 20px; padding:20px;">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-sm" name="curso_extra[]" placeholder="" value="{{$candidato->can_curso_extra[$i]}}" >
            </div>
            <div class="col-md-3">
        ...
        <div class="row g-3 shadow p-4 mb-5 bg-body rounded" style="margin:0px 20px 0px 20px; padding:20px;">
            ...
            <div class="col-md-4">
                ...
                <input type="text" class="form-control form-control-sm" name="utv_titlulo[]" placeholder="" value="{{$candidato->can_utv_titlulo[$i]}}">
            </div>
            <div class="col-md-2">
                <label class="form-check-label" for="flexCheckIndeterminate">Carga horária</label>
                <input type="text" class="form-control form-control-sm" name="utv_carga[]" placeholder="" value="{{$candidato->can_utv_carga[$i]}}">
            </div>
            <div class="col-md-2">
                <label class="form-check-label" for="flexCheckIndeterminate">Data de Emissão</label>
                <input type="month" class="form-control form-control-sm" name="utv_data[]" placeholder="" value="{{$candidato->can_utv_data[$i]}}">
            </div>
            ...
            <div class="row g-3 shadow p-3 mb-5 bg-body rounded" style="margin: 20px">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-select form-select-sm" name="idioma[]" id="idioma"
                        ...
                        <option selected></option>
                        <option {{$candidato->can_idioma[$i] == 'Inglês' ? 'selected' :''}} value="Inglês">Inglês</option>
                        <option {{$candidato->can_idioma[$i] == 'Francês' ? 'selected' :''}} value="Francês">Francês</option>
                        <option {{$candidato->can_idioma[$i] == 'Espanhol' ? 'selected' :''}} value="Espanhol">Espanhol</option>
                        <option {{$candidato->can_idioma[$i] == 'Outros' ? 'selected' :''}} value="Outros">Outros</option>
           ...
           @for($i = 0; $i <$tamanho4; $i++)
            ...
            <div class="row g-3 shadow p-3 mb-5 bg-body rounded" id="00" style="margin: 10px">
                ...
                <div class="col-md-2" id="06">
                    ...
                    <input type="text" class="form-control form-control-sm" placeholder="" name="salario_empres[]" value="{{$candidato->can_salario_empresa}}" onKeyPress="return(moeda(this,'.',',',event))" >
                </div>
