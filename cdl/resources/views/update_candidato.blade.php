        ...
        <div class="pessoais">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    @if($candidato->can_estadocivil == 'sim')
                        <div class="form-check ">
                            <input class="form-check-input" type="radio" name="filhos" id="gridRadios1" value="sim" checked>
                            <label class="form-check-label" for="gridRadios1">
                                Sim
                            </label>
                        </div>
                        <div class="form-check ">
                            <input class="form-check-input" type="radio" name="filiacao" id="gridRadios2" value="não">
                    ...
                    @else
                        <div class="form-check ">
                            <input class="form-check-input" type="radio" name="filhos" id="gridRadios1" value="sim" >
                            <label class="form-check-label" for="gridRadios1">
                                Sim
                            </label>
                        </div>
