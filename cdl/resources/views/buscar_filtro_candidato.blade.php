        ...
        <div class="row g-3 shadow p-4 mb-5 bg-body rounded">
            ...
            <div class="pessoais">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2" id="divMatricula">
                        <label class="form-check-label" for="flexCheckIndeterminate"><span style="color:red;">Avaliação
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        <label class="form-check-label"
                            for="flexCheckIndeterminate">Nº</label></label>></label>
...
<div class="row g-3 shadow p-3 mb-5 bg-body rounded" style="margin-bottom: 50px">
    ...
    <label class="form-check-label" for="flexCheckIndeterminate" style="margin-bottom: 5px"> Preferências
