    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #004691">
        <div class="container-fluid">
            ...
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item">
                    <a class="nav-link" target="_blank" href="https://www.instagram.com/cdlmanaus/?hl=en"><img
                            src="/icons/4.png" width="25px"></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" target="_blank"
                        href="https://www.youtube.com/channel/UCyjD5GbQuRrztgyRxlVAZdQ"><img src="/icons/3.png"
                            width="25px"></a>
                </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card" style="width: 25rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        <a href="/login/empresa" class="btn btn-outline-primary btn-lg btn-block">BUSCAR
                            OPORTUNIDADE</a>
                    </ul>
                </div>
            </div>
